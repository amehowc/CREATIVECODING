 ...
 *  SVG Runtime for p5.js.
 *
 *  Updated to support recent vesion of p5.js
 *
 *  Edits has been made in the background() function to flush the SVG childrens after clearing up the canvas,
 *  this prevent the <g> attribute to stack and makes the SVG files readable in Illustrator.
 *
 *  Despite numerous attempts, no contact has been established with the original author.
 *  Use this fix at your own perils. I'm not a professional coder :)
 *  github : /amehowc
 *  Edited in 2020-2021 by Arthur Cloche
 */
...
;(function() {
    ...
    ctx.prototype.__addTransform = function(t) {
        ...
        var parent = this.__currentElement;
    ...
    ctx.prototype.scale = function(x, y) {
        ...
        this.__addTransform(format("scale({x},{y})", {x:1, y:1}));
    };
     ...
     */
    ctx.prototype.getChildren = function(length) {
     ...
     * http://.whatwg.org/specs/web-apps/current-work/multipage/the-canvas-element.html#dom-context-2d-drawimage
     */
    ctx.prototype.drawImage = function(){
        ...
        if(image instanceof ctx) {
            ...
            svgImage.setAttribute("preserveAspectRatio", "1");
